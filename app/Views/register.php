...
<body id="registrobody">
    ...
    <!-- <div id="cachorroregistro"></div> -->

    <div class="conteinerregistro"> </div>
        <img class="cachorroregistro"src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/38816/image-from-rawpixel-id-542207-jpeg.png">
