...
return [
    ...
    'generator'          => [
        ...
        'className'       => [
            ...
            'entity'     => 'Nome da classe de entidade',
            'filter'     => 'Nome da classe de filtro',
            'migration'  => 'Nome da classe de migração',
            'model'      => 'Nome da classe de model',
            'seeder'     => 'Nome da classe de seeder',
            'validation' => 'Nome da classe de validação',
        ],
